      ...
      questions: [
        {
          ...
          answer: "每次生成消耗1点数。新用户注册获得10点免费体验。之后可购买点数包：50点(¥15)、100点(¥27)、300点(¥75)，或订阅会员获得更多权益。"
        },
        {
        ...
        },
        {
          ...
          answer: "虚拟点数一经使用不可退回。如遇系统异常导致多次失败扣点，可提供截图申请人工处理补点。"
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "1）描述要具体详细；2）选择合适的风格模板；3）开启AI优化功能；4）使用高级参数调节；5）多尝试不同的关键词组合。"
        }
      ]
    },
    {
